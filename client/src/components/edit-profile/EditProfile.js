...
class CreateProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      profile.githubusername = !isEmpty(profile.company) ? profile.company : "";
            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                <TextFieldGroup
                  ...
                  onChange={this.onChange}
                  error={errors.handle}
                  info="Choose a unique handle for your profile"
                />
                <SelectListGroup
                  placeholder="Status"
                  name="status"
                ...
                <TextFieldGroup
                  ...
                  onChange={this.onChange}
                  error={errors.skills}
                  info="Coding languages you use (separate by commas)"
                />
                <TextFieldGroup
